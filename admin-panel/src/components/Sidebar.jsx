    ...
    <div className="flex items-center justify-between">
      ...
      <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-purple-950 font-bold text-lg shadow-md cursor-pointer">
        ...
        <ul className="flex justify-between items-center flex-col gap-6 text-sm capitalize mt-12">
            ...
            <Link onClick={()=>dispatch(control.setnavbarclass("list"))}  className={` ${navbarclass=="list"?"bg-amber-500 hover:bg-cyan-700 cursor-pointer p-2 rounded-2xl transition ease-in-out duration-200 text-white ayder-3 border-gray-800":"bg-purple-600 hover:bg-purple-700 cursor-pointer p-2 rounded-2xl transition ease-in-out duration-200 text-white border-3 border-purple-600"}`}  > patients lists </Link>
            <Link onClick={()=>dispatch(control.setnavbarclass("enquiries"))}  className={` ${navbarclass=="enquiries"?"bg-amber-500 hover:bg-cyan-700 cursor-pointer p-2 rounded-2xl transition ease-in-out duration-200 text-white border-3 border-gray-800":"bg-purple-600 hover:bg-purple-700 cursor-pointer p-2 rounded-2xl transition ease-in-out duration-200 text-white border-3 border-purple-600"}`}  >Enquiries</Link>
            <Link onClick={()=>dispatch(control.setnavbarclass("five"))}  className={` ${navbarclass=="five"?"bg-amber-500 hover:bg-cyan-700 cucyanpointer p-2 rounded-2xl transition ease-in-out duration-200 text-white border-3 border-gray-800":"bg-purple-600 hover:bg-purple-700 cursor-purplet7r p-2 rounded-2xl transition ease-in-out duration-200 text-white border-3 border-purple-600"}`}  >add patients </Link>
            <Link onClick={()=>dispatch(control.setnavbarclass("dlist"))}  className={` ${navbarclass=="dlist"?"bg-amber-500 hover:bg-cyan-700 cursor-pointer p-2 rounded-2xl transition ease-in-out duration-200 text-white border-3 border-gray-800":"bg-purple-600 hover:bg-purple-700 cursor-pointer p-2 rounded-2xl transition ease-in-out duration-200 text-white border-3 border-purple-600"}`}  >departments list</Link>
