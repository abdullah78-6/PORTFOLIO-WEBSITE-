    ...
    <div className="flex items-center justify-between">
      ...
      <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-purple-950 font-bold text-lg shadow-md cursor-pointer">
        ...
        <ul className="flex justify-between items-center flex-col gap-20 text-sm capitalize mt-12 text-center">
            ...
            <Link to="/achivements" onClick={()=>dispatch(control.setnavbarclass("achive"))}  className={` ${navbarclass=="achive"?"bg-amber-500 hover:bg-cyan-700 cursor-pointer p-2 rounded-2xl transition ease-in-out duration-200 text-white border-3 border-gray-800":"bg-purple-600 hover:bg-purple-700 cursor-pointer p-2 rounded-2xl transition ease-in-out duration-200 text-white border-3 border-purple-600"}`}  >Achievements</Link>
            <Link to="/education" onClick={()=>dispatch(control.setnavbarclass("edu"))}  className={` ${navbarclass=="edu"?"bg-amber-500 hover:bg-cyan-700 cursor-pointer p-2 rounded-2xl transition ease-in-out duration-200 text-white border-3 border-gray-800":"bg-purple-600 hover:bg-purple-700 cursor-pointer p-2 rounded-2xl transition ease-in-out duration-200 text-white border-3 border-purple-600"}`}  >Education</Link>
