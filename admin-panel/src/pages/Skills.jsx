          ...
          <div className="flex justify-between items-center gap-9">
            ...
            <div className="flex justify-between items-center gap-60 ">
              ...
              <div className="flex flex-col justify-center items-center">
                ...
                <h1 className="text-purple-600 font-semibold capitalize  break-words">
                  {item.name}
                </h1>
              </div>
                  <div >
                <p className="text-xs text-gray-300 uppercase text-center mb-2">
                  Skill Logo
                </p>
                
                <img  className="w-24 h-20 rounded-lg hover:scale-125 transition ease-in-out duration-200" src={item.image}/>
              </div>
            </div>
